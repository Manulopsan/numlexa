...
Backend de NUMLEXA: Postgres mas Edge Functions en Deno/TypeScript.
Buena parte se trasplanta de Letrixa en F4 (ver `D-07`).
...
- **Las reglas del juego viven dos veces**, en Dart y en TypeScript. Todo lo
  que se implemente aqui y tenga equivalente en `packages/` pasa por los
  vectores de conformidad de `conformance/` (`D-08`, F0.10).
